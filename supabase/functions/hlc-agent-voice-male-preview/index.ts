...
const voiceProfiles: Record<MaleAgentId, VoiceProfile> = {
  ...
  dion: {
    ...
    direction: "Use a clean, fully voiced adult male speaking voice with a comfortable medium register and clear chest resonance, not a breathy or hushed tone. Speak at ordinary phone-conversation volume and keep the energy present from the first syllable through sentence endings. Dion should sound alert, practical, precise, and slightly quicker than Kendrell, like an operations and BI lead giving a concise spoken update. Articulation must be crisp and natural without sounding sharp or theatrical. Absolutely do not whisper, murmur, rasp, croak, speak under the breath, trail off, use vocal fry, gravel, scratchiness, breathy onset, excessive softness, or nasal thinness. The name Dion is pronounced Dee-Yon and HLC is spoken H L C.",
  },
};
