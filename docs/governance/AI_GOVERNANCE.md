...
- Character: analytical, active, operational.
...
## Shared Corporate DNA
All three belong to the same premium HomeLead environment:
- dark charcoal/navy architecture
- dark wood
- glass and restrained metal details
...
Presentation variants may change pose, crop, office, lighting, background, screen arrangement, and departmental setting.

A presentation variant never replaces canonical identity without explicit approval.

## Data Integrity
Do not portray fabricated business metrics as real HomeLead data. Concept visuals may use abstract or intentionally unreadable charts, queues, schedules, status shapes, and interface structures.
