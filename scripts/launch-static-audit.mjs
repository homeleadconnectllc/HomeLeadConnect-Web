...
requireText('src/pages/auth/Login.tsx', 'resolveUserDestination');
requireText('src/pages/auth/Login.tsx', 'return requestedDestination || await resolveUserDestination(userId);');
requireText('src/pages/auth/Login.tsx', 'navigate(await resolvedDestination(userId), { replace: true });');
requireText('src/pages/auth/Login.tsx', 'shouldCreateUser: !invitationFlow');
requireText('src/pages/auth/Register.tsx', 'account_type: invitedIdentity ? "workspace_invitee" : "company_owner"');
requireText('src/pages/auth/Register.tsx', 'next?.startsWith("/portal/accept?")');
requireText('src/pages/portal/AcceptInvitation.tsx', '/login?next=${encodedDestination}');
requireText('src/pages/portal/AcceptInvitation.tsx', '/register?next=${encodedDestination}');
