...
console.log("RESIDENT_LIFECYCLE_E2E_PASS", JSON.stringify({ userId, leadId, contractorId, matchId, estimateCount: relationship.estimates.length, jobCount: relationship.jobs.length }));
