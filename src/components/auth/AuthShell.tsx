  ...
  return (
    <main className="hlc-auth-shell hlc-auth-shell--flat">
      <style>{`
        ...
        @media(max-width:720px){ html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat { min-height:100vh !important; padding:0 0 24px !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat .hlc-auth-main { display:block !important; width:calc(100vw - 24px) !important; max-width:none !important; min-height:auto !important; margin:0 auto !important; padding:24px 0 0 !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat .hlc-auth-intro { display:none !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat .hlc-auth-card { display:grid !important; width:100% !important; max-width:none !important; padding:24px 18px !important; border-radius:18px !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-brand img { width:150px !important; max-height:52px !important; } }
      `}</style>
