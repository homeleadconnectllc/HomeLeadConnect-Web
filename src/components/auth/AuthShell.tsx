...
export default function AuthShell({
  ...
  return (
    <main className="hlc-auth-shell hlc-auth-shell--flat">
      <style>{`
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login { min-width:0 !important; background:#030914 !important; color:#f7fbff !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login > .hlc-route-content { width:100% !important; max-width:none !important; min-width:0 !important; padding:0 !important; background:#030914 !important; overflow:visible !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat { box-sizing:border-box !important; display:block !important; position:relative !important; width:100vw !important; max-width:none !important; min-width:100vw !important; min-height:100vh !important; margin:0 0 0 calc(50% - 50vw) !important; padding:0 0 40px !important; overflow:visible !important; border:0 !important; border-radius:0 !important; background:#030914 !important; box-shadow:none !important; color:#f7fbff !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav { position:relative !important; z-index:50 !important; isolation:isolate !important; background:rgba(2,8,18,.96) !important; background-color:rgba(2,8,18,.96) !important; border-bottom:1px solid rgba(98,198,255,.22) !important; color:#f7fbff !important; }
        ...
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-brand { display:flex !important; align-items:center !important; width:auto !important; height:auto !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-brand img { display:block !important; width:170px !important; height:auto !important; max-height:58px !important; object-fit:contain !important; border-radius:0 !important; }
        ...
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-links a.hlc-auth-public-request { color:#ffffff !important; -webkit-text-fill-color:#ffffff !important; background:#0b72d0 !important; }
        ...
        @media(max-width:720px){ html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat { min-height:100vh !important; padding:0 0 24px !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat .hlc-auth-main { display:block !important; width:calc(100vw - 24px) !important; max-width:none !important; min-height:auto !important; margin:0 auto !important; padding:24px 0 0 !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat .hlc-auth-intro { display:none !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-links a:not(.hlc-auth-public-request) { display:none !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-links .hlc-auth-public-request { display:inline-flex !important; min-height:40px !important; margin-left:0 !important; padding-inline:13px !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat .hlc-auth-card { display:grid !important; width:100% !important; max-width:none !important; padding:24px 18px !important; border-radius:18px !important; } html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-brand img { width:150px !important; max-height:52px !important; } }
      `}</style>
      <nav className="hlc-auth-public-nav" aria-label="Public site navigation">
        <div className="hlc-auth-public-nav-inner">
          <a className="hlc-auth-public-brand" href="https://homeleadconnect.org/" aria-label="HomeLead Connect home">
            <picture>
              <source type="image/webp" srcSet="/hlc-logo-transparent.png" />
