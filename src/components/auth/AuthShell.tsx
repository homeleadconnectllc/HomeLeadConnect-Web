  ...
  return (
    <main className="hlc-auth-shell hlc-auth-shell--flat">
      <style>{`
        ...
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav { position:relative !important; z-index:50 !important; isolation:isolate !important; background:#ffffff !important; background-color:#ffffff !important; border-bottom:1px solid #e2e8f0 !important; color:#0f172a !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-nav-inner { background:#ffffff !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-links a { color:#334155 !important; -webkit-text-fill-color:#334155 !important; background:transparent !important; }
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-links a.hlc-auth-public-request { color:#ffffff !important; -webkit-text-fill-color:#ffffff !important; background:#2563eb !important; }
