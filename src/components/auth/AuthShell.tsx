  ...
  return (
    <main className="hlc-auth-shell hlc-auth-shell--flat">
      <style>{`
        ...
        html body #root .hlc-app-shell.hlc-public-shell.hlc-page-login .hlc-auth-shell.hlc-auth-shell--flat > .hlc-auth-public-nav .hlc-auth-public-brand img { display:block !important; width:64px !important; height:64px !important; max-height:64px !important; padding:0 !important; object-fit:contain !important; border-radius:50% !important; background:transparent !important; box-shadow:none !important; }
