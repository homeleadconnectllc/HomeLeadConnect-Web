    ...
    <main class="hlc-board-home hlc-v2-home hlc-family-ecosystem">
      <header class="hlc-board-nav">
        <div class="hlc-board-nav-inner">
          <a class="hlc-board-brand" href="https://homeleadconnect.org/" aria-label="HomeLead Connect home"><img src="/brand/homelead-connect-master-transparent.png" alt="HomeLead Connect LLC" width="440" height="142" loading="eager" decoding="async" /></a>
      ...
      <section id="pathways" class="hlc-board-pathway-band" aria-labelledby="hlc-board-pathway-title">
        ...
        <div class="hlc-board-pathway-inner">
          <article class="hlc-board-pathway hlc-board-pathway--resident" style="background-image:url('https://images.pexels.com/photos/5727801/pexels-photo-5727801.jpeg?auto=compress&cs=tinysrgb&h=627&fit=crop&w=1200');background-size:cover;background-repeat:no-repeat;background-position:center 35%;"><div class="hlc-board-pathway-content"><p class="hlc-board-pathway-label">For Residents</p><p class="hlc-board-pathway-copy">Get help with the home in front of you—and keep the next step clear.</p><a class="hlc-family-pathway-link" href="/homeowners">Find resident support →</a></div></article>
          <article class="hlc-board-pathway hlc-board-pathway--professional" style="background-image:url('https://images.pexels.com/photos/442160/pexels-photo-442160.jpeg?cs=srgb&dl=pexels-field-engineer-147254-442160.jpg&fm=jpg');background-size:cover;background-repeat:no-repeat;background-position:center 30%;"><div class="hlc-board-pathway-content"><p class="hlc-board-pathway-label">For Professionals</p><p class="hlc-board-pathway-copy">Build a more visible, accountable service business inside the network.</p><a class="hlc-family-pathway-link" href="/professionals">Explore professional access →</a></div></article>
          <article class="hlc-board-pathway hlc-board-pathway--partner" style="background-image:url('https://images.pexels.com/photos/9430884/pexels-photo-9430884.jpeg?auto=compress&cs=tinysrgb&h=627&fit=crop&w=1200'),url('/partners-collaboration.svg');background-size:cover,cover;background-repeat:no-repeat,no-repeat;background-position:center 40%,center center;"><div class="hlc-board-pathway-content"><p class="hlc-board-pathway-label">For Partners</p><p class="hlc-board-pathway-copy">Create referral relationships that respect people, context, and consent.</p><a class="hlc-family-pathway-link" href="/partners">Explore partner access →</a></div></article>
          <article class="hlc-board-pathway hlc-board-pathway--community" style="background-image:url('https://images.pexels.com/photos/30477317/pexels-photo-30477317/free-photo-of-outdoor-church-community-gathering-in-clemson.jpeg?auto=compress&w=1600');background-size:cover;background-repeat:no-repeat;background-position:center 35%;"><div class="hlc-board-pathway-content"><p class="hlc-board-pathway-label">For Community</p><p class="hlc-board-pathway-copy">Find the people and resources that help neighborhoods move forward.</p><a class="hlc-family-pathway-link" href="/community">Visit the community →</a></div></article>
        </div>
      </section>
