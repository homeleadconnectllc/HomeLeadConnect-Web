    ...
    <main class="hlc-v2-home">
      ...
      <section class="hlc-v2-section hlc-v2-section--dark" aria-labelledby="hlc-v2-ecosystem-title">
        <div class="hlc-v2-wrap">
          ...
          <div class="hlc-v2-pathways">
            ...
            <article class="hlc-v2-card hlc-v2-card--partner"><img class="hlc-v2-card-media" src="/hlc-frontdoor-partner-collaboration.svg" alt="" width="1600" height="900" loading="eager" decoding="async" aria-hidden="true" /><div class="hlc-v2-card-content"><span class="hlc-v2-card-icon" aria-hidden="true">◎</span><h3>For Partners</h3><p>Collaborate. Invest. Build a bigger impact.</p><a href="https://partners.homeleadconnect.org/">Learn More →</a></div></article>
            <article class="hlc-v2-card hlc-v2-card--community"><img class="hlc-v2-card-media" src="/hlc-frontdoor-community-cinematic.svg" alt="" width="1600" height="900" loading="eager" decoding="async" aria-hidden="true" /><div class="hlc-v2-card-content"><span class="hlc-v2-card-icon" aria-hidden="true">◌</span><h3>For Our Community</h3><p>Stronger neighborhoods. Greater possibilities.</p><a href="https://community.homeleadconnect.org/">Learn More →</a></div></article>
          </div>
        </div>
      </section>
      ...
      <section class="hlc-v2-section hlc-v2-section--dark" aria-labelledby="hlc-v2-vision-title">
        <div class="hlc-v2-wrap hlc-v2-vision">
          ...
          <div class="hlc-v2-vision-media" role="img" aria-label="City and community visual"><img class="hlc-v2-vision-image" src="/hlc-frontdoor-vision-cityscape.svg" alt="" width="1600" height="900" loading="eager" decoding="async" aria-hidden="true" /></div>
        </div>
      </section>
