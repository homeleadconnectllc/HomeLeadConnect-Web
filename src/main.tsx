...
import "./styles/v2-real-stock-and-global-type-20260913.css";
      ...
      <header class="hlc-v2-nav">
        <div class="hlc-v2-nav-inner">
          <a class="hlc-v2-brand" href="https://homeleadconnect.org/" aria-label="HomeLead Connect home">
            <img src="/hlc-logo-public.webp" alt="HomeLead Connect LLC" width="220" height="71" loading="eager" decoding="async" />
          </a>
      ...
      <section class="hlc-v2-section hlc-v2-section--dark" aria-labelledby="hlc-v2-ecosystem-title">
        <div class="hlc-v2-wrap">
          ...
          <div class="hlc-v2-pathways">
            ...
            <article class="hlc-v2-card hlc-v2-card--professional"><img class="hlc-v2-card-media" src="https://images.pexels.com/photos/8487367/pexels-photo-8487367.jpeg?cs=srgb&amp;dl=pexels-kindelmedia-8487367.jpg&amp;fm=jpg" alt="" width="1000" height="1500" loading="eager" decoding="async" aria-hidden="true" /><div class="hlc-v2-card-content"><span class="hlc-v2-card-icon" aria-hidden="true">⌁</span><h3>For Professionals</h3><p>Grow your business. Get more opportunities.</p><a href="https://professionals.homeleadconnect.org/">Learn More →</a></div></article>
            <article class="hlc-v2-card hlc-v2-card--partner"><img class="hlc-v2-card-media" src="https://images.pexels.com/photos/5668452/pexels-photo-5668452.jpeg?cs=srgb&amp;dl=pexels-sora-shimazaki-5668452.jpg&amp;fm=jpg" alt="" width="1000" height="667" loading="eager" decoding="async" aria-hidden="true" /><div class="hlc-v2-card-content"><span class="hlc-v2-card-icon" aria-hidden="true">◎</span><h3>For Partners</h3><p>Collaborate. Invest. Build a bigger impact.</p><a href="https://partners.homeleadconnect.org/">Learn More →</a></div></article>
            <article class="hlc-v2-card hlc-v2-card--community"><img class="hlc-v2-card-media" src="https://images.pexels.com/photos/1128316/pexels-photo-1128316.jpeg?cs=srgb&amp;dl=pexels-panditwiguna-1128316.jpg&amp;fm=jpg" alt="" width="1000" height="667" loading="eager" decoding="async" aria-hidden="true" /><div class="hlc-v2-card-content"><span class="hlc-v2-card-icon" aria-hidden="true">◌</span><h3>For Our Community</h3><p>Stronger neighborhoods. Greater possibilities.</p><a href="https://community.homeleadconnect.org/">Learn More →</a></div></article>
          </div>
        </div>
      </section>
