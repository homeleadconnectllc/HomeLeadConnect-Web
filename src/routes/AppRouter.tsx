...
import MainSiteOnly from "./MainSiteOnly";
...
const ResidentLeadScope=lazy(()=>import("../pages/portal/ResidentLeadScope"));
...
const IntelligenceWorkspace=lazy(()=>import("../pages/dashboard/IntelligenceWorkspace"));
...
const SettingsHome=lazy(()=>import("../pages/dashboard/SettingsHome"));
...
<Route element={<PortalAccessBoundary audience="resident"/>}><Route path="/homeowner-portal" element={<HomeownerPortal/>}/><Route path="/homeowner-portal/leadscope" element={<ResidentLeadScope/>}/><Route path="/homeowner-portal/resources" element={<PortalResources audience="resident"/>}/><Route path="/homeowner-portal/requests" element={<HomeownerPortalSection section="requests"/>}/><Route path="/homeowner-portal/appointments" element={<HomeownerPortalSection section="appointments"/>}/><Route path="/homeowner-portal/jobs" element={<HomeownerPortalSection section="jobs"/>}/><Route path="/homeowner-portal/documents" element={<HomeownerPortalDocuments/>}/><Route path="/homeowner-portal/profile" element={<ResidentProfile/>}/><Route path="/homeowner-portal/settings" element={<ResidentProfile/>}/><Route path="/homeowner-portal/properties" element={<PropertyIntelligence/>}/><Route path="/homeowner-portal/matches" element={<Navigate to="/homeowner-portal" replace/>}/></Route>
<Route element={<PortalAccessBoundary audience="professional"/>}><Route path="/contractor-portal" element={<ContractorPortal/>}/><Route path="/contractor-portal/resources" element={<PortalResources audience="professional"/>}/><Route path="/contractor-portal/profile" element={<ContractorProfile />}/><Route path="/contractor-portal/services" element={<ContractorPortalServices/>}/><Route path="/contractor-portal/documents" element={<ContractorPortalDocuments/>}/><Route path="/contractor-portal/team" element={<Navigate to="/contractor-portal" replace/>}/></Route>
<Route element={<PortalAccessBoundary audience="partner"/>}><Route path="/partner-portal" element={<PartnerPortal/>}/><Route path="/partner-portal/resources" element={<PortalResources audience="partner"/>}/></Route>
<Route path="/messages" element={<Messages/>}/><Route path="/notifications" element={<Notifications/>}/><Route path="/academy" element={<AcademyWorkspace/>}/><Route path="/academy/paths" element={<AcademyWorkspace/>}/><Route path="/academy/practice/:moduleId" element={<AcademyWorkspace/>}/><Route path="/academy/certifications" element={<AcademyWorkspace/>}/><Route path="/academy/progress" element={<AcademyWorkspace/>}/><Route path="/academy/roleplay" element={<RoleplayKnowledgeWorkspace/>}/><Route path="/academy/library" element={<RoleplayKnowledgeWorkspace/>}/>
