...
<Route element={<ProtectedLayout/>}><Route path="/homeowner-portal" element={<HomeownerPortal/>}/><Route path="/contractor-portal" element={<ContractorPortal/>}/><Route path="/homeowner-portal/requests" element={<HomeownerPortalSection section="requests"/>}/><Route path="/homeowner-portal/appointments" element={<HomeownerPortalSection section="appointments"/>}/><Route path="/homeowner-portal/jobs" element={<HomeownerPortalSection section="jobs"/>}/><Route path="/homeowner-portal/documents" element={<HomeownerPortalDocuments/>}/><Route path="/homeowner-portal/profile" element={<ResidentProfile/>}/><Route path="/homeowner-portal/settings" element={<ResidentProfile/>}/><Route path="/contractor-portal/profile" element={<ContractorProfile />}/><Route path="/contractor-portal/services" element={<ContractorPortalServices/>}/><Route path="/contractor-portal/documents" element={<ContractorPortalDocuments/>}/><Route path="/messages" element={<Messages/>}/><Route path="/notifications" element={<Notifications/>}/>
<Route element={<WorkspaceLayout/>}>
<Route path="/dashboard" element={<Dashboard/>}/><Route path="/start-here" element={<StartHere/>}/><Route path="/ecosystem" element={<Ecosystem/>}/><Route path="/workflow" element={<Workflow/>}/><Route path="/automations" element={<Automations/>}/><Route path="/activity" element={<WorkspaceActivity/>}/>
<Route path="/network" element={<LaunchSurface page="network"/>}/><Route path="/map" element={<ProviderMap/>}/><Route path="/network/map" element={<ProviderMap/>}/><Route path="/profiles" element={<LaunchSurface page="profiles"/>}/><Route path="/providers" element={<LaunchSurface page="providers"/>}/><Route path="/providers/:providerId" element={<LaunchSurface page="providerDetail"/>}/><Route path="/matching" element={<CommunityMatchDeck/>}/><Route path="/network/service-areas" element={<LaunchSurface page="serviceAreas"/>}/><Route path="/network/availability" element={<LaunchSurface page="availability"/>}/><Route path="/network/eligibility" element={<EligibilityFit/>}/><Route path="/network/saved" element={<LaunchSurface page="saved"/>}/>
<Route path="/community-hub" element={<CommunityHub/>}/><Route path="/community/discussions" element={<LaunchSurface page="discussions"/>}/><Route path="/community/reviews" element={<LaunchSurface page="reviews"/>}/><Route path="/community/referrals" element={<LaunchSurface page="referrals"/>}/><Route path="/community/events" element={<LaunchSurface page="events"/>}/><Route path="/community/moderation" element={<LaunchSurface page="moderation"/>}/><Route path="/community/groups" element={<LaunchSurface page="groups"/>}/>
<Route path="/help" element={<OperationalGuide page="help"/>}/><Route path="/tutorials" element={<OperationalGuide page="tutorials"/>}/><Route path="/rules" element={<OperationalGuide page="rules"/>}/><Route path="/profile" element={<MyProfile/>}/><Route path="/homeowner-portal/properties" element={<PropertyIntelligence/>}/><Route path="/homeowner-portal/matches" element={<EligibilityFit/>}/><Route path="/contractor-portal/team" element={<LaunchSurface page="team"/>}/><Route path="/analytics" element={<Analytics/>}/><Route path="/hq/approvals" element={<LaunchSurface page="approvals"/>}/><Route path="/hq/system-health" element={<LaunchSurface page="systemHealth"/>}/>
<Route path="/settings/billing" element={<EcosystemAreaPage page="billing"/>}/><Route path="/leads" element={<Leads/>}/><Route path="/leads/:leadId" element={<LeadDetail/>}/><Route path="/estimator" element={<Estimator/>}/><Route path="/jobs" element={<Jobs/>}/><Route path="/jobs/:jobId" element={<JobDetail/>}/><Route path="/calendar" element={<Calendar/>}/><Route path="/settings" element={<Settings/>}/><Route path="/team" element={<Team/>}/><Route path="/follow-ups" element={<FollowUps/>}/><Route path="/manual-communications" element={<ManualCommunications/>}/><Route path="/documents" element={<Documents/>}/><Route path="/call-center" element={<CallCenter/>}/><Route path="/hq/dedication" element={<KendrellDedication/>}/><Route path="/hq" element={<AgentWorkspace agentId="kendrell"/>}/><Route path="/operations" element={<AgentWorkspace agentId="dion"/>}/><Route path="/customer-experience" element={<AgentWorkspace agentId="diamond"/>}/>
