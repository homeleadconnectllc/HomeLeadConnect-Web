...
<Route element={<ProtectedLayout/>}><Route path="/homeowner-portal" element={<HomeownerPortal/>}/><Route path="/contractor-portal" element={<ContractorPortal/>}/><Route path="/homeowner-portal/requests" element={<HomeownerPortalSection section="requests"/>}/><Route path="/homeowner-portal/appointments" element={<HomeownerPortalSection section="appointments"/>}/><Route path="/homeowner-portal/jobs" element={<HomeownerPortalSection section="jobs"/>}/><Route path="/contractor-portal/profile" element={<ContractorProfile />}/><Route path="/messages" element={<Messages/>}/><Route path="/notifications" element={<Notifications/>}/>
...
<Route path="/help" element={<LaunchSurface page="help"/>}/><Route path="/tutorials" element={<LaunchSurface page="tutorials"/>}/><Route path="/rules" element={<LaunchSurface page="rules"/>}/><Route path="/profile" element={<MyProfile/>}/><Route path="/homeowner-portal/profile" element={<MyProfile/>}/><Route path="/homeowner-portal/properties" element={<LaunchSurface page="properties"/>}/><Route path="/homeowner-portal/matches" element={<LaunchSurface page="matching"/>}/><Route path="/contractor-portal/team" element={<LaunchSurface page="team"/>}/><Route path="/contractor-portal/services" element={<LaunchSurface page="services"/>}/><Route path="/analytics" element={<LaunchSurface page="analytics"/>}/><Route path="/hq/approvals" element={<LaunchSurface page="approvals"/>}/><Route path="/hq/system-health" element={<LaunchSurface page="systemHealth"/>}/>
