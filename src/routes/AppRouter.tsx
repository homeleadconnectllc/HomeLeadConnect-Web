...
<Route element={<ProtectedLayout/>}><Route path="/homeowner-portal" element={<HomeownerPortal/>}/><Route path="/contractor-portal" element={<ContractorPortal/>}/><Route path="/partner-portal" element={<PartnerPortal/>}/><Route path="/homeowner-portal/resources" element={<PortalResources audience="resident"/>}/><Route path="/contractor-portal/resources" element={<PortalResources audience="professional"/>}/><Route path="/partner-portal/resources" element={<PortalResources audience="partner"/>}/><Route path="/homeowner-portal/requests" element={<HomeownerPortalSection section="requests"/>}/><Route path="/homeowner-portal/appointments" element={<HomeownerPortalSection section="appointments"/>}/><Route path="/homeowner-portal/jobs" element={<HomeownerPortalSection section="jobs"/>}/><Route path="/homeowner-portal/documents" element={<HomeownerPortalDocuments/>}/><Route path="/homeowner-portal/profile" element={<ResidentProfile/>}/><Route path="/homeowner-portal/settings" element={<ResidentProfile/>}/><Route path="/contractor-portal/profile" element={<ContractorProfile />}/><Route path="/contractor-portal/services" element={<ContractorPortalServices/>}/><Route path="/contractor-portal/documents" element={<ContractorPortalDocuments/>}/><Route path="/messages" element={<Messages/>}/><Route path="/notifications" element={<Notifications/>}/><Route path="/academy" element={<AcademyWorkspace/>}/><Route path="/academy/paths" element={<AcademyWorkspace/>}/><Route path="/academy/practice/:moduleId" element={<AcademyWorkspace/>}/><Route path="/academy/certifications" element={<AcademyWorkspace/>}/><Route path="/academy/progress" element={<AcademyWorkspace/>}/><Route path="/academy/roleplay" element={<RoleplayKnowledgeWorkspace/>}/><Route path="/academy/library" element={<RoleplayKnowledgeWorkspace/>}/>
