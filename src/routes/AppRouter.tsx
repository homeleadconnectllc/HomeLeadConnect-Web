...
<Route element={<PortalAccessBoundary audience="resident"/>}><Route path="/homeowner-portal" element={<HomeownerPortal/>}/><Route path="/homeowner-portal/resources" element={<PortalResources audience="resident"/>}/><Route path="/homeowner-portal/requests" element={<HomeownerPortalSection section="requests"/>}/><Route path="/homeowner-portal/appointments" element={<HomeownerPortalSection section="appointments"/>}/><Route path="/homeowner-portal/jobs" element={<HomeownerPortalSection section="jobs"/>}/><Route path="/homeowner-portal/documents" element={<HomeownerPortalDocuments/>}/><Route path="/homeowner-portal/profile" element={<ResidentProfile/>}/><Route path="/homeowner-portal/settings" element={<ResidentProfile/>}/><Route path="/homeowner-portal/properties" element={<PropertyIntelligence/>}/><Route path="/homeowner-portal/matches" element={<Navigate to="/homeowner-portal" replace/>}/></Route>
