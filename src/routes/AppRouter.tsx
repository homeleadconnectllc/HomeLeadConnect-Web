...
const CommunityParticipation=lazy(()=>import("../pages/dashboard/CommunityParticipation"));
...
<Route path="/community-hub" element={<CommunityHub/>}/><Route path="/community/discussions" element={<CommunityParticipation page="discussions"/>}/><Route path="/community/reviews" element={<LaunchSurface page="reviews"/>}/><Route path="/community/referrals" element={<LaunchSurface page="referrals"/>}/><Route path="/community/events" element={<CommunityParticipation page="events"/>}/><Route path="/community/moderation" element={<LaunchSurface page="moderation"/>}/><Route path="/community/groups" element={<CommunityParticipation page="groups"/>}/>
