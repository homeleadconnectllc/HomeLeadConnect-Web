...
<Route path="/help" element={<LaunchSurface page="help"/>}/><Route path="/tutorials" element={<LaunchSurface page="tutorials"/>}/><Route path="/rules" element={<LaunchSurface page="rules"/>}/><Route path="/profile" element={<MyProfile/>}/><Route path="/homeowner-portal/profile" element={<MyProfile/>}/><Route path="/homeowner-portal/properties" element={<LaunchSurface page="properties"/>}/><Route path="/homeowner-portal/matches" element={<LaunchSurface page="matching"/>}/><Route path="/contractor-portal/team" element={<LaunchSurface page="team"/>}/><Route path="/contractor-portal/services" element={<LaunchSurface page="services"/>}/><Route path="/analytics" element={<Analytics/>}/><Route path="/hq/approvals" element={<LaunchSurface page="approvals"/>}/><Route path="/hq/system-health" element={<LaunchSurface page="systemHealth"/>}/>
