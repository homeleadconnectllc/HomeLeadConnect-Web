...
export const canonicalPageMap: CanonicalPageArea[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      page("Service Requests", "/homeowner-portal/requests", "Diamond", "Linked homeowner or renter", "MISSING"),
      page("Provider Matches", "/homeowner-portal/matches", "Dion", "Linked homeowner or renter", "MISSING"),
      page("Appointments", "/homeowner-portal/appointments", "Dion", "Linked homeowner or renter", "MISSING"),
      page("Jobs", "/homeowner-portal/jobs", "Dion", "Linked homeowner or renter", "MISSING"),
  ...
  },
  {
    ...
    pages: [
      ...
      page("Business/Provider Profile", "/contractor-portal/profile", "Diamond", "Linked professional", "MISSING"),
