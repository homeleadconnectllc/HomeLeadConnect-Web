...
export const automationRegistry: HlcAutomation[] = [
  ...
  { stage: "LeadScope", name: "Evidence completeness reminder", owner: "Dion", mode: "AUTOMATIC", trigger: "A LeadScope draft lacks required known evidence.", outcome: "Identify missing property, urgency, scope, photo or note fields.", guardrail: "Unknown information stays unknown; automation never invents quantities or pricing." },
