...
export default function Legal({ page }: { page: LegalPage }) {
  return <main style={{ width: "min(820px, calc(100% - 32px))", margin: "48px auto", lineHeight: 1.65 }}>
    ...
    {page === "terms" && <>
      ...
      <p>The Pennsylvania V1 software plan includes a 14-day free trial and then renews monthly at $99 USD unless cancelled. A payment method is required to start the trial; no subscription charge is scheduled before the trial ends. Enrollment requires affirmative acknowledgment of the displayed trial length, recurring price, first-charge timing, and cancellation method.</p>
