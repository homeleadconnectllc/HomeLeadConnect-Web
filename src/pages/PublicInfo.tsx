...
const communitySections = [
  ...
  ["Plan service", "Service Areas & Availability", "Review recorded service-area and availability information before moving into assignment and scheduling.", "/network/service-areas", "View service areas"],
