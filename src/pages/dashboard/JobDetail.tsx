  ...
  return (
    <main className="hlc-job-detail">
      ...
      <header className="hlc-job-detail__header">
        ...
        <strong className="hlc-job-detail__status" data-scheduled={scheduledWork ? "true" : "false"}>{scheduledWork ? "Scheduled Work" : "Not Scheduled Work"}</strong>
      </header>
