    ...
    <main className="hlc-home-v2">
      ...
      <section className="hlc-home-hero-v2">
        <div className="hlc-home-hero-copy-v2">
          ...
          <div className="hlc-home-utility-links"><a href="/login">Sign In</a><a href="/register">Create Account</a><a href="/app" data-route-to="/app">Open HLC App</a><a href="/contact">Contact HLC</a></div>
        </div>
      ...
      <section className="hlc-home-section hlc-home-connection" aria-labelledby="connection-title">
        ...
        <div className="hlc-connection-flow" aria-label="Resident to HLC to professional connection">
          ...
          <div className="hlc-flow-hlc"><img src="/hlc-logo-transparent.png" alt="" loading="lazy"/><strong>HomeLead Connect</strong><small>Reviews & coordinates</small></div><span className="hlc-flow-arrow">→</span>
      ...
      <section className="hlc-home-section hlc-trust-section">
        ...
        <div className="hlc-trust-links"><a href="/community" data-route-to="/community">Community</a><a href="/trust">Trust & safety</a><a href="/about">About HLC</a></div>
      </section>

      <section className="hlc-home-section hlc-business-strip">
        <div><p className="hlc-home-kicker">FOR PARTICIPATING BUSINESSES</p><h2>Try the connected HLC workspace free for 14 days.</h2><p>Continue for $49.99/month after the trial. Payment method required.</p><a className="hlc-business-account-link" href="/register">Create My HLC Account</a></div><a className="hlc-btn hlc-btn-primary" href="/register">Start 14-Day Free Trial</a>
      </section>
    </main>
    <Footer />
  </>;
