  ...
  return <>
    <main className="hlc-home-v2">
      ...
      <section className="hlc-home-hero-v2">
        <div className="hlc-home-hero-copy-v2">
          ...
          <div className="hlc-home-actions">
            <Link className="hlc-btn hlc-btn-primary" to="/request-service">Request Home Service</Link>
            <Link className="hlc-btn hlc-btn-secondary" to="/professionals">For Professionals</Link>
          </div>
          <div className="hlc-home-utility-links"><Link to="/login">Sign in</Link><Link to="/register">Create account</Link><Link to="/contact">Contact HLC</Link></div>
        </div>
      ...
      <section className="hlc-home-section hlc-trust-section">
        ...
        <div className="hlc-trust-links"><Link to="/community">Community</Link><Link to="/trust">Trust & safety</Link><Link to="/about">About HLC</Link></div>
      </section>

      <section className="hlc-home-section hlc-business-strip">
        <div><p className="hlc-home-kicker">FOR PARTICIPATING BUSINESSES</p><h2>Try the connected HLC workspace free for 14 days.</h2><p>Continue for $49.99/month after the trial. Payment method required.</p></div><Link className="hlc-btn hlc-btn-primary" to="/register">Start 14-Day Free Trial</Link>
      </section>
    </main>
    <Footer />
  </>;
