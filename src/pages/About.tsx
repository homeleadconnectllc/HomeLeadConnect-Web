...
export default function AboutPage() {
  ...
  return <main className="hlc-public-page hlc-public-board-page" data-public-page="about">
    ...
    <div className="hlc-public-shell hlc-public-shell--visual">
      ...
      <section className="hlc-public-offer hlc-kendrell-dedication" aria-label="Kendrell dedication"><p className="hlc-public-offer-label">A Brother’s Dedication</p><h2>A name carried forward with purpose</h2><p>Antoine Washington created the Kendrell command office to carry his brother’s name forward with purpose, care, and family pride.</p><Link className="hlc-public-link" to="/memorial">Visit the full Kendrell Memorial →</Link></section>
