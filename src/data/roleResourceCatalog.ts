...
export const RESIDENT_DIRECTORY_RESOURCES: readonly RoleResource[] = [
  ...
  },
  {
    ...
    phone: "211",
    note: "Dial 211 or use PA 211 to search by ZIP code. Program eligibility and availability can change.",
  ...
  },
  {
    ...
    phone: "211",
    note: "Eligibility varies by program, location, income, household circumstances, and available funding.",
